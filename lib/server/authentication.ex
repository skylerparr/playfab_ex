defmodule PlayfabEx.Server.Authentication do
  ...
  [online docs](https://api.playfab.com/documentation/server/method/AuthenticateSessionTicket)
  """
  ...
  [online docs](https://api.playfab.com/documentation/server/method/SetPlayerSecret)
  """
