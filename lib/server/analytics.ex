defmodule PlayfabEx.Server.Analytics do
  ...
  [online docs](https://api.playfab.com/documentation/server/method/WriteCharacterEvent)
  """
  ...
  [online docs](https://api.playfab.com/documentation/server/method/WritePlayerEvent)
  """
  ...
  [online docs](https://api.playfab.com/documentation/server/method/WriteTitleEvent)
  """
