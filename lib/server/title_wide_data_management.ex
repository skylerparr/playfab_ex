defmodule PlayfabEx.Server.TitleWideDataManagement do
  ...
  [online docs](https://api.playfab.com/documentation/server/method/GetCatalogItems)
  """
  ...
  [online docs](https://api.playfab.com/documentation/server/method/GetPublisherData)
  """
  ...
  [online docs](https://api.playfab.com/documentation/server/method/GetTime)
  """
  ...
  [online docs](https://api.playfab.com/documentation/server/method/GetTitleData)
  """
  ...
  [online docs](https://api.playfab.com/documentation/server/method/GetTitleInternalData)
  """
  ...
  [online docs](https://api.playfab.com/documentation/server/method/GetTitleNews)
  """
  ...
  [online docs](https://api.playfab.com/documentation/server/method/SetPublisherData)
  """
  ...
  [online docs](https://api.playfab.com/documentation/server/method/SetTitleData)
  """
  ...
  [online docs](https://api.playfab.com/documentation/server/method/SetTitleInternalData)
  """
