defmodule PlayfabEx.Client.PlatformSpecificMethods do
  ...
  [online docs](https://api.playfab.com/documentation/client/method/AndroidDevicePushNotificationRegistration)
  """
  ...
  [online docs](https://api.playfab.com/documentation/client/method/RegisterForIOSPushNotification)
  """
  ...
  [online docs](https://api.playfab.com/documentation/client/method/RestoreIOSPurchases)
  """
  ...
  [online docs](https://api.playfab.com/documentation/client/method/ValidateAmazonIAPReceipt)
  """
  ...
  [online docs](https://api.playfab.com/documentation/client/method/ValidateGooglePlayPurchase)
  """
  ...
  [online docs](https://api.playfab.com/documentation/client/method/ValidateIOSReceipt)
  """
  ...
  [online docs](https://api.playfab.com/documentation/client/method/ValidateWindowsStoreReceipt)
  """
