defmodule PlayfabEx.Client.PlayStream do
  ...
  [online docs](https://api.playfab.com/documentation/client/method/GetPlayerSegments)
  """
  ...
  [online docs](https://api.playfab.com/documentation/client/method/GetPlayerTags)
  """
