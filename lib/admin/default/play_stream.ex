defmodule PlayfabEx.Admin.Default.PlayStream do
  ...
  def add_player_tag(params) do
    fetch("Admin/AddPlayerTag", params)
  end
  ...
  def get_all_segments(params) do
    fetch("Admin/GetAllSegments", params)
  end
  ...
  def get_player_segments(params) do
    fetch("Admin/GetPlayerSegments", params)
  end
  ...
  def get_players_in_segment(params) do
    fetch("Admin/GetPlayersInSegment", params)
  end
  ...
  def get_player_tags(params) do
    fetch("Admin/GetPlayerTags", params)
  end
  ...
  def remove_player_tag(params) do
    fetch("Admin/RemovePlayerTag", params)
  end
