defmodule PlayfabEx.Admin.Matchmaking do
  ...
  [online docs](https://api.playfab.com/documentation/admin/method/GetMatchmakerGameInfo)
  """
  ...
  [online docs](https://api.playfab.com/documentation/admin/method/GetMatchmakerGameModes)
  """
  ...
  [online docs](https://api.playfab.com/documentation/admin/method/ModifyMatchmakerGameModes)
  """
